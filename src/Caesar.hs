...
-- three letters further down in the alphabet, wrapping around
-- at the end of alphabet. This method can be improve changing
-- the shift factor by any number between one and twenty five.
--
...
-- |Frequencies of twenty six letters of alphabet
table :: [Float]
...
-- frequency and @es@, an /expected frequency/. Smaller
...
--
-- Assumes that @n@ is between 0 and @length xs@
rotate :: Int -> [a] -> [a]
